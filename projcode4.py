...
for digit_list in full_digits_data:
    ...
    gmm = GaussianMixture(n_components=4,covariance_type='spherical').fit(unpacked)
    gmm_list.append(gmm)
    g1 = []
    g2 = []
    g3 = []
...
custom_dots = [Line2D([0], [0], marker='o', color='w', label='Cluster 0', markerfacecolor='r', markersize=12),
               ...
               Line2D([0], [0], marker='o', color='w', label='Cluster 3', markerfacecolor='g', markersize=12)
               ]
...
plt.title("MFCCs For Digit 0, Observation 0, k=4 Clusters",fontsize=15)
