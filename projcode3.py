# -*- coding: utf-8 -*-
"""
Created on Sun Nov 13 15:59:04 2022
...
plt.title("KMeans Confusion Matrix, n_clusters={}, n_features={}".format(3,n_dims))
...
# plt.xlabel("True Digit")
# plt.ylabel("Predicted Digit")
plt.title("GMM Confusion Matrix, n_clusters={}, n_features={}".format(3,n_dims))
plt.yticks(fontsize=10)
s = sn.heatmap(df_cm, annot=True,fmt='g')
s.set(xlabel="Predicted Digit",ylabel="True Digit",font_scale=2)
